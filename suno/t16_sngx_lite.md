...
> ⚠️ Эмпирическая проверка 2026-08-04 (chirp v5-5, custom, 2 вариации): `[quality: anchor pristine]` в ЛИРИКЕ **спевается как текст** — возвращённый lyric: «Quality / Anchor pristine», скобки сняты и спеты. Скобки `[quality:…]` в лирике НЕ инструкция. Правило подтверждено: в лирике только структурные теги `[Verse]/[Chorus]/[Intro]/[Bridge]/[Outro]`; поведенческие теги — только в STYLE.
